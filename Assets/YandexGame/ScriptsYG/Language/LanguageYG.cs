...
namespace YG
{
    ...
    public class LanguageYG : MonoBehaviour
    {
        ...
        void Update()
        {
            if (textMeshProComponent != null && textMeshProComponent.text != _value || textt != null && textt.text != _value || textMeshPro != null && textMeshPro.text != _value || tMP_Text != null && tMP_Text.text != _value)
            {
                Translate();
            }
        }
        ...
        private void Translate()
        {
            if (textMeshProComponent != null)
            {
                ...
                {
                    textMeshProComponent.text = ru;
                }
                else if (YandexGame.savesData.language == "tr")
                {
                    textMeshProComponent.text = tr;
                }
                else if (YandexGame.savesData.language == "be")
                {
                    textMeshProComponent.text = be;
                }
                else if (YandexGame.savesData.language == "kk")
                {
                    textMeshProComponent.text = kk;
                }
                else if (YandexGame.savesData.language == "uz")
                {
                    textMeshProComponent.text = uz;
                }
                else if (YandexGame.savesData.language == "es")
                {
                    textMeshProComponent.text = es;
                }
                else if (YandexGame.savesData.language == "de")
                {
                    textMeshProComponent.text = de;
                }
                else
                {
                    textMeshProComponent.text = en;
                }
                _value = textMeshProComponent.text;
            }
            else if (textt != null)
            {
                if (YandexGame.savesData.language == "ru" | YandexGame.savesData.language == "uk")
